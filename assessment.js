...
var myFriends = ["Jon","Andy","Adam","Joseph"]// CODE HERE
...
/*function evensOnly(arr) {
  evensArray=[]
  for(i=0;i<arr.length;i++){if(arr[i]%2===0){evensArray.push(arr[i])}}
return evensArray}
evensOnly(myNumbers)*/
 function evensOnly(){evensArray = myNumbers.filter(item => item%2==0);return evensArray} // CODE HERE
